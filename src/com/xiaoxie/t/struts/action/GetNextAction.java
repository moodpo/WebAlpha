 ...
 * @struts.action
 */
public class GetNextAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(type.equals("down")){//向下翻页
			...
			int allNum=new MsgService().getAllMsgNum(uId);
			int pageSize=10;
			int pageNum=(allNum%pageSize==0)?(allNum/pageSize):(allNum/pageSize+1);
			if(nowPage>=pageNum){
				request.setAttribute("pageTishi", "没有了！");
				return mapping.findForward("nohave");
			}
			MsgSet_PageNum mspn=new MsgService().getMsgSetByUId(uId, nowPage+1, 10);
