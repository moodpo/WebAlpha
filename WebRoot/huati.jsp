  ...
  <div id="light" class="white_content">
    ...
    <div id="dencontent">
      <form action="login.do" method="post" onSubmit="return docheck()" id="form-login">
        ...
        <input type="text" id="email" name="email" value="请输入邮箱地址..." onFocus="clearuEmail()"/>
        </span> <br />
        <br/>
        <span id="expw">输入密码:
        <input type="password" value="请输入密码..." id="pw" name="pw" onFocus="clearuPW()"/>
        </span> <br />
      ...
      <div>
        <div id="daohang">
          <ul>
            ...
            <li><a href="huati.do" style="background-color:#FFF; color:#000">话题</a></li>
  ...
  <div id="sidebarcenter">
    ...
    <div id="content">
      <div id="main-left">
        ...
        <div id="huaex">
          <ul >
          <logic:present name="heSet" scope="request">
          <logic:notEmpty name="heSet" scope="request">
          <logic:iterate id="myHe" name="heSet" scope="request">
            <li>
              <div class="htitle"><bean:write name="myHe" property="hTitle" filter="false"/></div>
              <div class="hcon">
                <p><bean:write name="myHe" property="hCon" filter="false"/></p>
              </div>
            </li>
            </logic:iterate>
            </logic:notEmpty>
        ...
        <logic:iterate id="myMsg" name="msgSet" scope="request">
          <div style="width: 630px; margin: 0 auto;">
            ...
            <div class="msg">
              ...
              <!--img-->
              <div class="msg-img"><img src='<bean:write name="myMsg" property="user.uImg"/>' width="60" height="60"/> </div>
              <!--end img-->
              <div class="msgandname">
                <!--msgandname-->
                <div class="msgandname_c"> 
                <a href="visit.do?vuid=<bean:write name='myMsg' property='user.uId'/>">${myMsg.user.uName }</a>: ${myMsg.mCon }</div>
                <!--end#msgandname-->
                <!--time-->
                <div style="width: auto; height: 20px; float: right;">
                  <div> 
                    <logic:notPresent name="umspn" scope="session">
                     <a href="javascript:void(0)" onclick="dodenlu()">forword(${myMsg.mfNum })</a>&nbsp;&nbsp;&nbsp;&nbsp;
                     <a href="javascript:void(0)" onclick="dodenlu()">hide</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    </logic:notPresent>
                  	<logic:present name="umspn" scope="session">
                     <a href="javascript:void(0)" onclick="doHF(this,'${myMsg.mId}','${myMsg.user.uId }')">forword(${myMsg.mfNum})</a>&nbsp;&nbsp;&nbsp;&nbsp; 
                     <a href="javascript:void(0)" onclick="doHide(this,'${myMsg.mId}')">hide</a>&nbsp;&nbsp;&nbsp;&nbsp; 
                    </logic:present>
                  </div>
                </div>
                <!--end#msgtime-->
